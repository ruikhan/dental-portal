...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $password) {
        $stmt = $conn->prepare("SELECT * FROM admin_users WHERE (username = ? OR email = ?) AND is_active = 1 LIMIT 1");
...
<head>
    ...
    <title>Admin Login — DentalPortal</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-input:focus {
            ...
            box-shadow: 0 0 0 4px rgba(10,143,143,0.1);
        }
        .toggle-pw {
            position: absolute;
            right: 14px; top: 50%;
        ...
        .btn-login {
            ...
            cursor: pointer;
            transition: all 0.2s;
            box-shadow: 0 4px 16px rgba(10,143,143,0.3);
            margin-top: 8px;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 6px 22px rgba(10,143,143,0.4);
        }
        .alert-error {
            background: rgba(214,51,72,0.08);
            border: 1px solid rgba(214,51,72,0.2);
            color: #a0172a;
            padding: 12px 16px;
            border-radius: 10px;
            font-size: 0.875rem;
        ...
        .default-creds {
            background: rgba(10,143,143,0.07);
        ...
        .default-creds strong { display: block; margin-bottom: 4px; font-size: 0.82rem; }
...
<div class="login-brand">
    ...
    <h1 class="brand-title">DentalPortal<br>Management</h1>
    <p class="brand-desc">
        A complete dental clinic management system — patients, appointments, billing, analytics and more, all in one place.
    </p>
    <div class="brand-features">
        <div class="brand-feature">
            <i class="bi bi-people-fill"></i>
            Patient Records & Case Tracking
        </div>
        <div class="brand-feature">
...
<div class="login-form-panel">
    ...
    <div class="default-creds">
        <strong><i class="bi bi-info-circle"></i> Default Credentials</strong>
        Username: <strong>admin</strong> &nbsp;|&nbsp; Password: <strong>password</strong><br>
        <span style="color:#0a8f8f;">⚠ Change your password immediately after first login.</span>
    </div>
    ...
    <div class="login-footer">
        <p>Patient? <a href="../patient-portal/login.php">Go to Patient Portal →</a></p>
    </div>
</div>
